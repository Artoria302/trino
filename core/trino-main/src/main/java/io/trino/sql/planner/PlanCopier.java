...
public final class PlanCopier
{
            ...
            extends SimplePlanRewriter<Void>
    {
        ...
        {
            return new RangePartitionNode(idAllocator.getNextId(), context.rewrite(node.getSource()), context.rewrite(node.getSampleSource()), node.getPartitionSymbol(), node.getOrderingScheme(), node.getSampleOrderingSymbols(), node.getSampleSize(), node.canPruneSymbol());
        }
    }
}
