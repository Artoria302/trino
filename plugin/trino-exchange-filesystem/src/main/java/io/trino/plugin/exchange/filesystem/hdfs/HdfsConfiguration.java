...
public class HdfsConfiguration
{
    ...
    @NotNull
    public static Configuration getConfiguration(ExchangeHdfsConfig config)
    {
        Configuration configuration = newEmptyConfiguration();
        copy(getInitialConfiguration(), configuration);
        copy(readConfiguration(config.getResourceConfigFiles()), configuration);
