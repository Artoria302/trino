...
import io.trino.plugin.iceberg.fileio.DefaultIcebergFileSystemFactory;
        ...
        implements Module
{
    ...
    public ExecutorService createSplitManagerExecutor(CatalogName catalogName, IcebergConfig config)
    {
        ...
        return newThreadPool(
                ...
                daemonThreadsNamed("yunzhou-split-manager-" + catalogName + "-%s"));
    }

    @Provides
    @Singleton
    @ForIcebergMetadata
    public ExecutorService createMetadataExecutor(CatalogName catalogName, IcebergConfig config)
    {
        ...
        return newThreadPool(
                ...
                daemonThreadsNamed("yunzhou-metadata-" + catalogName + "-%s"));
    }
