        ...
        implements DeleteFilter
{
    ...
    private EqualityDeleteFilter(Schema deleteSchema, StructLikeSet deleteSet)
    {
    ...
    public static EqualityDeleteFilter readEqualityDeletes(ConnectorPageSource pageSource, List<IcebergColumnHandle> columns, Schema tableSchema)
    {
