        ...
        implements IcebergTableOperationsProvider
{
    ...
    @Inject
    public HiveMetastoreTableOperationsProvider(TrinoFileSystemFactory fileSystemFactory, ThriftMetastoreFactory thriftMetastoreFactory, CacheManager cacheManager)
    {
