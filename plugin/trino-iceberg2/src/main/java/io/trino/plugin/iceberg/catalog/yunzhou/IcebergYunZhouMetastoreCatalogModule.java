...
public class IcebergYunZhouMetastoreCatalogModule
        extends AbstractConfigurationAwareModule
{
    ...
    protected void setup(Binder binder)
    {
        ...
        binder.bind(IcebergTableOperationsProvider.class).to(YunZhouMetastoreTableOperationsProvider.class).in(Scopes.SINGLETON);
        binder.bind(TrinoCatalogFactory.class).to(TrinoYunZhouCatalogFactory.class).in(Scopes.SINGLETON);
