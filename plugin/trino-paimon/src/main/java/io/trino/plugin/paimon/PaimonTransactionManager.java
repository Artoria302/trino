...
public class PaimonTransactionManager
{
    ...
    public PaimonMetadata get(ConnectorTransactionHandle transactionHandle, ConnectorSession session)
    {
    ...
    private class MemoizedMetadata
    {
        ...
        public synchronized PaimonMetadata get(ConnectorSession session)
        {
            if (metadata == null) {
                try (ThreadContextClassLoader ignored = new ThreadContextClassLoader(classLoader)) {
