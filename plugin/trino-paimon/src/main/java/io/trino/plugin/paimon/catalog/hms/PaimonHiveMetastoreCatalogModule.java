...
import io.trino.plugin.paimon.catalog.MetastoreValidator;
...
public class PaimonHiveMetastoreCatalogModule
        extends AbstractConfigurationAwareModule
{
    ...
    protected void setup(Binder binder)
    {
        ...
        binder.bind(PaimonCatalogFactory.class).to(PaimonHiveMetastoreCatalogFactory.class).in(Scopes.SINGLETON);
