...
public class PaimonTypeUtils
{
    ...
    {
        return type.accept(PaimonToTrinoTypeVisitor.INSTANCE);
    }
    ...
    private static class PaimonToTrinoTypeVisitor
            extends DataTypeDefaultVisitor<Type>
    {
        private static final PaimonToTrinoTypeVisitor INSTANCE = new PaimonToTrinoTypeVisitor();
