 ...
 */
package io.trino.plugin.archer.optimizer;
...
import io.trino.plugin.archer.ArcherConnector;
import io.trino.plugin.archer.ArcherPlugin;
import io.trino.plugin.archer.ArcherTableHandle;
import io.trino.plugin.archer.ColumnIdentity;
import io.trino.plugin.archer.TestingArcherConnectorFactory;
...
public class TestConnectorPushdownRulesWithArcher
        extends BaseRuleTest
{
    ...
    protected Optional<PlanTester> createPlanTester()
    {
        ...
        new ArcherPlugin().getFunctions().forEach(functions::functions);
        planTester.addFunctions(functions.build());

        planTester.createCatalog(
                TEST_CATALOG_NAME,
                new TestingArcherConnectorFactory(baseDir.toPath()),
                ImmutableMap.of());
        catalogHandle = planTester.getCatalogHandle(TEST_CATALOG_NAME);

        metastore = ((ArcherConnector) planTester.getConnector(TEST_CATALOG_NAME)).getInjector()
    ...
    public void testProjectionPushdown()
    {
        ...
        ArcherTableHandle archerTable = new ArcherTableHandle(
        ...
        ArcherColumnHandle fullColumn = partialColumn.getBaseColumn();

        // Test projected columns pushdown to ArcherTableHandle in case of full column references
        tester().assertThat(pushProjectionIntoTableScan)
                ...
                .matches(
                        project(
                                ...
                                tableScan(
                                        archerTable.withProjectedColumns(ImmutableSet.of(fullColumn))::equals,
                                        TupleDomain.all(),
                                        ImmutableMap.of("col", fullColumn::equals))));

        // Rule should return Optional.empty after projected ColumnHandles have been added to ArcherTableHandle
        tester().assertThat(pushProjectionIntoTableScan)
                .on(p ->
                        p.project(
                                Assignments.of(p.symbol("struct_of_int", baseType), p.symbol("struct_of_int", baseType).toSymbolReference()),
                                p.tableScan(
                                        new TableHandle(
                                                catalogHandle,
                                                archerTable.withProjectedColumns(ImmutableSet.of(fullColumn)),
        ...
        tester().assertThat(pushProjectionIntoTableScan)
                ...
                .matches(project(
                        ...
                        tableScan(
                                archerTable.withProjectedColumns(ImmutableSet.of(partialColumn))::equals,
                                TupleDomain.all(),
    ...
    public void testPredicatePushdown()
    {
        ...
        ArcherTableHandle handle = (ArcherTableHandle) tester().getPlanTester().getTableHandle(TEST_CATALOG_NAME, SCHEMA_NAME, tableName).connectorHandle();
        ...
        ArcherColumnHandle column = new ArcherColumnHandle(primitiveColumnIdentity(1, "a"), INTEGER, ImmutableList.of(), INTEGER, true, Optional.empty());
        ...
        tester().assertThat(pushPredicateIntoTableScan)
                ...
                .matches(filter(
                        new Comparison(EQUAL, new Reference(INTEGER, "a"), new Constant(INTEGER, 5L)),
                        tableScan(
                                tableHandle -> ((ArcherTableHandle) tableHandle).getUnenforcedPredicate().getDomains().get()
    ...
    public void testColumnPruningProjectionPushdown()
    {
        ...
        ArcherColumnHandle columnA = new ArcherColumnHandle(primitiveColumnIdentity(0, "a"), INTEGER, ImmutableList.of(), INTEGER, true, Optional.empty());
        ArcherColumnHandle columnB = new ArcherColumnHandle(primitiveColumnIdentity(1, "b"), INTEGER, ImmutableList.of(), INTEGER, true, Optional.empty());
        ...
        tester().assertThat(pruneTableScanColumns)
                ...
                .matches(
                        strictProject(
                                ...
                                tableScan(
                                        archerTable.withProjectedColumns(ImmutableSet.of(columnA))::equals,
                                        TupleDomain.all(),
    ...
    public void testPushdownWithDuplicateExpressions()
    {
        ...
        ArcherColumnHandle bigintColumn = new ArcherColumnHandle(primitiveColumnIdentity(1, "just_bigint"), BIGINT, ImmutableList.of(), BIGINT, true, Optional.empty());
        ArcherColumnHandle partialColumn = new ArcherColumnHandle(
        ...
        tester().assertThat(pushProjectionIntoTableScan)
                ...
                .matches(project(
                        ...
                        tableScan(
                                archerTable.withProjectedColumns(ImmutableSet.of(bigintColumn))::equals,
                                TupleDomain.all(),
