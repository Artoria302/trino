...
import io.trino.plugin.archer.ArcherSchemaProperties;
        ...
        extends BaseTrinoCatalogTest
{
    ...
    {
        return Map.of(ArcherSchemaProperties.LOCATION_PROPERTY, "s3://%s/%s".formatted(bucketName, newNamespaceName));
    }
}
