...
public class TestingArcherHiveMetastoreCatalogModule
        extends AbstractConfigurationAwareModule
{
    private final HiveMetastore hiveMetastore;
    private final ThriftMetastoreFactory thriftMetastoreFactory;

    public TestingArcherHiveMetastoreCatalogModule(HiveMetastore hiveMetastore, ThriftMetastoreFactory thriftMetastoreFactory)
    {
    ...
    protected void setup(Binder binder)
    {
        ...
        binder.bind(ArcherTableOperationsProvider.class).to(HiveMetastoreTableOperationsProvider.class).in(Scopes.SINGLETON);
        ...
        configBinder(binder).bindConfigDefaults(CachingHiveMetastoreConfig.class, config -> {
            // ensure caching metastore wrapper isn't created, as it's not leveraged by archer
