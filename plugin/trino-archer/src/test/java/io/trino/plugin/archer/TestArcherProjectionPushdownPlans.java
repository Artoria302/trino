...
public class TestArcherProjectionPushdownPlans
        extends BasePushdownPlanTest
{
    private static final TestingFunctionResolution FUNCTIONS = new TestingFunctionResolution();
    private static final ResolvedFunction ADD_INTEGER = FUNCTIONS.resolveOperator(OperatorType.ADD, ImmutableList.of(INTEGER, INTEGER));

    private static final String CATALOG = "archer";
    ...
    protected PlanTester createPlanTester()
    {
        ...
        planTester.installPlugin(new TestingArcherPlugin(metastoreDir.toPath()));
        planTester.createCatalog(CATALOG, "archer", ImmutableMap.of());

        HiveMetastore metastore = ((ArcherConnector) planTester.getConnector(CATALOG)).getInjector()
    ...
    public void testDereferencePushdown()
    {
        ...
        ArcherColumnHandle column0Handle = (ArcherColumnHandle) columns.get("col0");
        ArcherColumnHandle column1Handle = (ArcherColumnHandle) columns.get("col1");

        ArcherColumnHandle columnX = new ArcherColumnHandle(
                ...
                true,
                Optional.empty());
        ArcherColumnHandle columnY = new ArcherColumnHandle(
                column0Handle.getColumnIdentity(),
                column0Handle.getType(),
        ...
        assertPlan(
                ...
                any(tableScan(
                        equalTo(((ArcherTableHandle) tableHandle.get().connectorHandle()).withProjectedColumns(Set.of(columnX, columnY))),
                        TupleDomain.all(),
        ...
        assertPlan(
                ...
                anyTree(
                        filter(
                                ...
                                tableScan(
                                        table -> {
                                            ArcherTableHandle archerTableHandle = (ArcherTableHandle) table;
                                            TupleDomain<ArcherColumnHandle> unenforcedConstraint = archerTableHandle.getUnenforcedPredicate();
                                            return archerTableHandle.getProjectedColumns().equals(ImmutableSet.of(column1Handle, columnX, columnY)) &&
                        ...
                        filter(
                                ...
                                tableScan(
                                        table -> {
                                            ArcherTableHandle archerTableHandle = (ArcherTableHandle) table;
                                            TupleDomain<ArcherColumnHandle> unenforcedConstraint = archerTableHandle.getUnenforcedPredicate();
                                            return archerTableHandle.getProjectedColumns().equals(ImmutableSet.of(column0Handle, columnX)) &&
                        ...
                        project(
                                ...
                                join(INNER, builder -> builder
                                                        ...
                                                        filter(
                                                                ...
                                                                tableScan(
                                                                        table -> {
                                                                            ArcherTableHandle archerTableHandle = (ArcherTableHandle) table;
                                                                            TupleDomain<ArcherColumnHandle> unenforcedConstraint = archerTableHandle.getUnenforcedPredicate();
                                                                            Set<ArcherColumnHandle> expectedProjections = ImmutableSet.of(column0Handle, column1Handle, columnX);
                                                                            TupleDomain<ArcherColumnHandle> expectedUnenforcedConstraint = TupleDomain.withColumnDomains(
                                                                                    ImmutableMap.of(columnX, Domain.singleValue(BIGINT, 2L)));
                                                                            return archerTableHandle.getProjectedColumns().equals(expectedProjections) &&
                                        ...
                                        .right(
                                                anyTree(
                                                        tableScan(
                                                                equalTo(((ArcherTableHandle) tableHandle.get().connectorHandle()).withProjectedColumns(Set.of(column1Handle))),
                                                                TupleDomain.all(),
