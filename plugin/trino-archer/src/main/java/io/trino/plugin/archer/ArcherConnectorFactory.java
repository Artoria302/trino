...
import io.trino.plugin.archer.catalog.ArcherCatalogModule;
...
public class ArcherConnectorFactory
        implements ConnectorFactory
{
    ...
    {
        ClassLoader classLoader = ArcherConnectorFactory.class.getClassLoader();
        try (ThreadContextClassLoader _ = new ThreadContextClassLoader(classLoader)) {
            Bootstrap app = new Bootstrap(
                    new EventModule(),
                    new MBeanModule(),
                    new ConnectorObjectNameGeneratorModule("io.trino.plugin.archer", "trino.plugin.archer"),
                    new JsonModule(),
                    new ArcherModule(),
                    new ArcherSecurityModule(),
                    archerCatalogModule.orElse(new ArcherCatalogModule()),
            ...
            ArcherTransactionManager transactionManager = injector.getInstance(ArcherTransactionManager.class);
            ...
            ArcherTableProperties archerTableProperties = injector.getInstance(ArcherTableProperties.class);
            ArcherMaterializedViewProperties materializedViewProperties = injector.getInstance(ArcherMaterializedViewProperties.class);
            ...
            return new ArcherConnector(
                    ...
                    ArcherSchemaProperties.SCHEMA_PROPERTIES,
                    archerTableProperties.getTableProperties(),
