        ...
        implements SystemTable
{
    ...
    public PropertiesTable(SchemaTableName tableName, Table archerTable)
    {
    ...
    {
        return new FixedPageSource(buildPages(tableMetadata, archerTable));
    }

    private static List<Page> buildPages(ConnectorTableMetadata tableMetadata, Table archerTable)
    {
        PageListBuilder pagesBuilder = PageListBuilder.forTable(tableMetadata);

        archerTable.properties().entrySet().forEach(prop -> {
