...
import net.qihoo.archer.NullOrder;
import net.qihoo.archer.Schema;
import net.qihoo.archer.SortField;
import net.qihoo.archer.SortOrder;
import net.qihoo.archer.SortOrderBuilder;
...
import static io.trino.plugin.archer.ArcherTableProperties.SORTED_BY_PROPERTY;
...
public final class SortFieldUtils
{
    ...
    {
        verify(field.transform().isIdentity(), "Archer sort transforms are not supported");
