...
public class ArcherWritableTableHandle
        implements ConnectorInsertTableHandle, ConnectorOutputTableHandle
{
    ...
    private final Optional<String> invertedIndexAsJson;
    private final List<ArcherColumnHandle> inputColumns;
    ...
    @JsonCreator
    public ArcherWritableTableHandle(
            ...
            @JsonProperty("invertedIndexAsJson") Optional<String> invertedIndexAsJson,
            @JsonProperty("inputColumns") List<ArcherColumnHandle> inputColumns,
            ...
            @JsonProperty("retryMode") RetryMode retryMode)
    {
        ...
        this.invertedIndexAsJson = requireNonNull(invertedIndexAsJson, "invertedIndexAsJson is null");
    ...
    @JsonProperty
    public Optional<String> getInvertedIndexAsJson()
    {
        return invertedIndexAsJson;
    }

    @JsonProperty
    public List<ArcherColumnHandle> getInputColumns()
    {
        return inputColumns;
    }
