...
import io.trino.plugin.archer.PartitionTransforms.ValueTransform;
...
public class ArcherBucketFunction
        implements BucketFunction
{
    ...
    public ArcherBucketFunction(
            TypeOperators typeOperators,
            PartitionSpec partitionSpec,
            List<ArcherColumnHandle> partitioningColumns,
            int bucketCount)
    {
        ...
        partitionColumns = partitionSpec.fields().stream()
                .map(field -> {
                    ...
                    return new PartitionColumn(channel, transform.valueTransform(), transform.type());
                })
