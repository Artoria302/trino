...
/*
 * Serializable version of ConnectorMaterializedViewDefinition stored by archer connector
 */
public record ArcherMaterializedViewDefinition(
        String originalSql,
        ...
        List<CatalogSchemaName> path)
{
    ...
    private static final JsonCodec<ArcherMaterializedViewDefinition> materializedViewCodec =
            new JsonCodecFactory(new ObjectMapperProvider()).jsonCodec(ArcherMaterializedViewDefinition.class);

    public static String encodeMaterializedViewData(ArcherMaterializedViewDefinition definition)
    {
    ...
    public static ArcherMaterializedViewDefinition decodeMaterializedViewData(String data)
    {
    ...
    public static ArcherMaterializedViewDefinition fromConnectorMaterializedViewDefinition(ConnectorMaterializedViewDefinition definition)
    {
        return new ArcherMaterializedViewDefinition(
    ...
    public ArcherMaterializedViewDefinition
    {
