...
/**
 * An interface to allow different Archer catalog implementations in ArcherMetadata.
 * <p>
 * It mimics the Archer catalog interface, with the following modifications:
 * <ul>
 *   <li>ConnectorSession is added at the front of each method signature</li>
 *   <li>String is used to identify namespace instead of Archer Namespace, Optional.empty() is used to represent Namespace.empty().
 *      This delegates the handling of multi-level namespace to each implementation</li>
 *   <li>Similarly, SchemaTableName is used to identify table instead of Archer TableIdentifier</li>
 ...
 *      These methods will likely be updated once Archer view interface is added.</li>
 * </ul>
 */
public interface TrinoCatalog
{
    ...
    /**
     * load an Archer table
     *
     * @param session Trino session
     * @param schemaTableName Trino schema and table name
     * @return Archer table loaded
     * @throws UnknownTableTypeException if table is not of Archer type in the metastore
     */
