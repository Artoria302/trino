...
import net.qihoo.archer.exceptions.CommitFailedException;
import net.qihoo.archer.exceptions.CommitStateUnknownException;
import net.qihoo.archer.io.FileIO;
import net.qihoo.archer.util.PropertyUtil;
...
import static net.qihoo.archer.TableProperties.COMMIT_NUM_STATUS_CHECKS;
import static net.qihoo.archer.TableProperties.COMMIT_NUM_STATUS_CHECKS_DEFAULT;
import static net.qihoo.archer.TableProperties.COMMIT_STATUS_CHECKS_MAX_WAIT_MS;
import static net.qihoo.archer.TableProperties.COMMIT_STATUS_CHECKS_MAX_WAIT_MS_DEFAULT;
import static net.qihoo.archer.TableProperties.COMMIT_STATUS_CHECKS_MIN_WAIT_MS;
import static net.qihoo.archer.TableProperties.COMMIT_STATUS_CHECKS_MIN_WAIT_MS_DEFAULT;
import static net.qihoo.archer.TableProperties.COMMIT_STATUS_CHECKS_TOTAL_WAIT_MS;
import static net.qihoo.archer.TableProperties.COMMIT_STATUS_CHECKS_TOTAL_WAIT_MS_DEFAULT;
    ...
    private CommitStatus checkCommitStatus(String newMetadataLocation, TableMetadata config)
    {
        ...
        Tasks.foreach(newMetadataLocation)
                ...
                .onFailure((location, checkException) ->
                        log.error(checkException, "Cannot check if commit to {}, where location is {}.", tableName, location))
                .run(_ -> {
                    TableMetadata metadata = refresh();
                    String currentMetadataLocation = metadata.location();
