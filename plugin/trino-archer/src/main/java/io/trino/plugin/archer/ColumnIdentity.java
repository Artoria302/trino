...
public class ColumnIdentity
{
            ...
            @JsonProperty("children") List<ColumnIdentity> children)
    {
        ...
        checkArgument(
                children.isEmpty() == (typeCategory == TypeCategory.PRIMITIVE),
    ...
    {
        return new ColumnIdentity(id, name, TypeCategory.PRIMITIVE, ImmutableList.of());
    }
    ...
    public static ColumnIdentity createColumnIdentity(Types.NestedField column)
    {
        ...
        net.qihoo.archer.types.Type fieldType = column.type();
        ...
        if (fieldType.isListType()) {
            ...
            return new ColumnIdentity(id, name, TypeCategory.ARRAY, ImmutableList.of(elementColumn));
        }
        ...
        throw new UnsupportedOperationException(format("Archer column type %s is not supported", fieldType.typeId()));
    }
}
