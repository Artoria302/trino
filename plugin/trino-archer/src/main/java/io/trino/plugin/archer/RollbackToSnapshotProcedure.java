        ...
        implements Provider<Procedure>
{
    ...
    public void rollbackToSnapshot(ConnectorSession clientSession, String schema, String table, Long snapshotId)
    {
        ...
        try (ThreadContextClassLoader ignored = new ThreadContextClassLoader(classLoader)) {
            ...
            Table archerTable = catalogFactory.create(clientSession.getIdentity()).loadTable(clientSession, schemaTableName);
            archerTable.manageSnapshots().setCurrentSnapshot(snapshotId).commit();
        }
    }
}
