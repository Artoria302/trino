...
public class ArcherPartitioningHandle
        implements ConnectorPartitioningHandle
{
    private final List<String> partitioning;
    private final List<ArcherColumnHandle> partitioningColumns;

    @JsonCreator
    public ArcherPartitioningHandle(
            @JsonProperty("partitioning") List<String> partitioning,
            @JsonProperty("partitioningColumns") List<ArcherColumnHandle> partitioningColumns)
    {
    ...
    @JsonProperty
    public List<ArcherColumnHandle> getPartitioningColumns()
    {
